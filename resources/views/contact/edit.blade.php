      ...
      <div class="row">
        ...
        <div class=" col-sm-4 ">
			<div class="form-group">
				...
				{!! Form::select('default_delivery_person_id',$delivery_people, $contact->default_delivery_person_id , ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'),'id' => 'delivery_person_id', 'style' => 'width: 100%;' ]); !!}
