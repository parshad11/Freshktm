...
<form action="{{ route('counter.update', $counter_info->id)}}" class="form" method="POST" enctype="multipart/form-data">
    @csrf
    @method('put')
        ...
        <div class="col-md-10">
            <div class="row" style="margin-bottom: 10px;">
                <div class="col-md-8" style="padding:0 10px 0 0;">
                    ...
                    <input type="number" value="{{ $counter_info->farmers }}" min=0 name="farmers" class="form-control">
                </div>
            </div>
            <div class="row" style="margin-bottom: 10px;">
                <div class="col-md-8" style="padding:0 10px 0 0;">
                    <label for="clients" class="control-label">Happy Clients:</label>
                    <input type="number" value="{{ $counter_info->clients }}" min=0 name="clients" class="form-control">
                </div>
            </div>
            <div class="row" style="margin-bottom: 10px;">
                <div class="col-md-8" style="padding:0 10px 0 0;">
                    <label for="staffs" class="control-label">Staffs:</label>
                    <input type="number" value="{{ $counter_info->staffs }}" min=0 name="staffs" class="form-control">
                </div>
            </div>
            <div class="row" style="margin-bottom: 10px;">
                <div class="col-md-8" style="padding:0 10px 0 0;">
                    <label for="awards" class="control-label">Awards won:</label>
                    <input type="number" value="{{ $counter_info->awards }}" min=0 name="awards" class="form-control">
                </div>
            </div>
        </div>
    </div>
